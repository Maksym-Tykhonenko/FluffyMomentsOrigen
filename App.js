...
////////////////////////////////////////////////////////////////
import FluffyMomentsOrigenProductScreen from './screen/FluffyMomentsOrigenProductScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://breathtaking-distinguished-success.space/`;
  const URL_IDENTIFAIRE = `7yq1Xk9B`;
  ...
  OneSignal.initialize('4d80166f-73d6-4c86-91d5-4f70513ddaff');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="FluffyMomentsOrigenProductScreen"
            component={FluffyMomentsOrigenProductScreen}
